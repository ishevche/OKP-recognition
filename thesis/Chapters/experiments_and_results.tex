...
\begin{figure}
    \centering
    \subfloat[\textsf{ILP}]{\includegraphics[width=.3\textwidth]{experiments/outcome_ilp}}
    \subfloat[\textsf{SAT}]{\includegraphics[width=.3\textwidth]{experiments/outcome_sat}}
    \subfloat[\textsf{DP}]{\includegraphics[width=.3\textwidth]{experiments/outcome_okp}}
    \caption{}
    \label{fig:vertex-dist}
\end{figure}
\todo{Why the plots whould be placed here? We obtained this data from the results of Section 4.3}
