...
\begin{figure}
    \centering
    \subfloat[\textsf{ILP}\label{fig:optimisation:ilp}]{\includegraphics[width=\textwidth]{experiments/ilp}}
    \hfill
    \subfloat[\textsf{SAT}\label{fig:optimisation:sat}]{\includegraphics[width=0.5\textwidth]{experiments/sat}}
