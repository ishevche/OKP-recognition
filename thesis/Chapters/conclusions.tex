...
Secondly, we could optimise the underlying algorithms discussed in this work. In particular, it would be desirable to simplify the algorithm for very small values of \(k\). \todo{Was this sentence there as a suggestion, or as a comment to me?}Can outer \(2\)-planar graphs be recognised in, say, quadratic time?
