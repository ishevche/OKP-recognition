...
\thesistitle{Practical Aspects of Recognising Outer \(k\)-Planar Graphs} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
% UCU_APPS_logo.pdf 
            ...
            \vfill
            {\large Lviv 2025}\\\currenttime\\[4cm] % Date
