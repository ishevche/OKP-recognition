...
\usepackage[backend=bibtex,natbib=true,maxbibnames=99]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
...
\thesistitle{Recognition of Outer \(k\)-planar Graphs} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisorone{Prof. Dr. Alexander \textsc{Wolff}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
\supervisortwo{Yuto \textsc{Okada}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\emph{Supervisor:} \\
\href{https://www.informatik.uni-wuerzburg.de/algo/team/wolff-alexander/}{\supnameone} \\ % Supervisor name - remove the \href bracket to remove the link
\href{https://yutookada.com/en/}{\supnametwo} % Supervisor name - remove the \href bracket to remove the link
\end{flushright}
\end{minipage}\\[3cm]
